    ...
    return (
      <Layout >
        ...
        <div>
              ...
              <p className="my-4">The first time I heard about Mindvalley, It was by the time when a close friend recommended me to start to meditate 
              ...
              <p className="my-4">I felt motivated to apply because <span className="font-bold">I've seen how your company culture had help people in your team to be 
              ...
              <p className="my-4">Based on this abilities and passions I consider I'm the perfect candidate for the product designer role: </p>
              <ul className="pl-6 list-disc list-inside">
                <li> <span className="font-bold">My excitement towards Mindvalley’s mission.</span>  My thesis is a good example of it because I did a deep research about personal 
                ...
                <li> I combine both of my strengths: <span className="font-bold">developer by night and designer by day.</span></li>
                <li> I <span className="font-bold">love doing user flows</span> for my designs and sometimes to organize my ideas.</li>
                <li> As you can check in my projects I use <span className="font-bold"> UX artifacts for my designs</span> and research.</li>
                ...
                <li> I'm used to work with Adobe Photoshop, Adobe Illustrator, <span className="font-bold">Figma</span> and Sketch.</li>
                <li> I like to <span className="font-bold">understand the user, the problem and design based on the user behavioural data</span> (using tools like Hotjar).</li>
                <li> I love UX! I consider that <span className="font-bold">understanding the user and loving the problem </span> has helped me to bring more amazing ideas
                  (as you can check in my projects). </li>
              </ul>
              <p className="mt-6"> I have a challenging mission where I want to <span className="font-bold">create a startup/agency </span>(that's why my domain is platino.digital), where I
              ...
              <p className="mt-6">At the same time, I would love to have a <span className="font-bold">project/side business related with mental or physical health</span> 
