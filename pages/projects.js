    ...
    <Layout>
      ...
      <section>
        <div className="py-16 storibckg" >
          ...
          <div className="flex justify-around px-16 mt-4">
            <a href="/stori# Process"><button className="px-2 py-1 font-semibold text-white bg-transparent border rounded hover:bg-white-500 hover:text-white border-white-700 hover:border-transparent">Design Process</button></a>
            <a href="/stori# Main problem"><button className="px-2 py-1 font-semibold text-white bg-transparent border rounded hover:bg-white-500 hover:text-white border-white-700 hover:border-transparent">Problem</button></a>
      ...
      <section>
        <div className="estereobckg">
          ...
          <div className="flex justify-around px-16 mt-4">
            <a href="/estereo"><button className="px-2 py-1 font-semibold text-white bg-transparent border rounded hover:bg-white-500 hover:text-white border-white-700 hover:border-transparent">Design Process</button></a>
            <a href="/estereo"><button className="px-2 py-1 font-semibold text-white bg-transparent border rounded hover:bg-white-500 hover:text-white border-white-700 hover:border-transparent">Problem</button></a>
      ...
      <section>
        ...
        <h2 className="pt-10 text-xl text-center text-black">Foodie experience</h2>
          ...
          <div className="flex justify-around px-16 mt-4">
            <a href="/backpackers"><button className="px-2 py-1 font-semibold text-black bg-transparent border border-black rounded hover:bg-white-500 hover:text-white hover:border-white">Design Process</button></a>
            <a href="/backpackers"><button className="px-2 py-1 font-semibold text-black bg-transparent border border-black rounded hover:bg-white-500 hover:text-white hover:border-white">Problem</button></a>
