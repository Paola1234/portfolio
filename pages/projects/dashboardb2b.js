        ...
        <section className={utilStyles.headingMd}>
            ...
            <section id="tools">
             ...
             <section id="problem" >
                ...
                <p className="mt-4 mb-4"> Currently in Colombia, the companies that rent charters (+20 companies) had some of their processes  in acrylic boards or in several spreadsheets.</p>
             ...
             <section id="persona">
                ...
                <img src="/images/UserPersonaB2B .jpg"
                alt="User Persona B2B"/>
            </section>

            <section id="userstory">
                <h3 className="mt-8 text-3xl font-bold text-black"> User Story 1</h3>
                <p className="mt-2">As a charter operator, I want to know which are the flights that where reserved with Flapz and all the information needed for the logistics </p>
                <p>so that will allow me to prepare the Flapz flights on time.</p>
                <h3 className="text-3xl font-bold text-black">Solution</h3>
                <p></p>
            </section>

            <section id="userstory2">
                <h3 className="mt-8 text-3xl font-bold text-black"> User Story 2</h3>
                <p className="mt-2">As a charter operator, I want to do a follow up of my fleet state</p>
                <p>so that will allow Flapz and me to know which of the charters in my fleet are available to rent.</p>
                <h3 className="text-3xl font-bold text-black">Solution</h3>
            </section>

            <section id="userstory3">
                <h3 className="mt-8 text-3xl font-bold text-black"> User Story 3</h3>
                <p className="mt-2">As a charter operator, I want to do follow up of my pilots information, such as the flight hours done in the current month or when does their licenses expire</p>
                <p>so that will allow me to know if they can be asign to any of the coming flights.</p>
                <p>so that we can show the quote on real time.</p>
                <h3 className="text-3xl font-bold text-black">Solution</h3>
            </section>

            <section id="userstory4">
                <h3 className="mt-8 text-3xl font-bold text-black"> User Story 4 and 5</h3>
                <p className="mt-2">As a charter operator, I don't want to fill repeated information for each one of the quotes that I receive</p>
                <p>so that will allow me to have more time to do other logistic things needed.</p>
                <p className="mt-2">As Flapz, I want to know the price of each charter per route</p>
                <p>so that we can show the quote on real time.</p>
                <h3 className="text-3xl font-bold text-black">Solution</h3>
            </section>
